    ...
    <div class="grid grid-flow-row gap-4">
                ...
                <div class="grid grid-flow-row grid-rows-[30px,_minmax(70px,_max-content),_minmax(50px,_max-content)]">
                    ...
                    <div class="grid grid-cols-[repeat(auto-fit,_minmax(20px,_160px))]">
                        <div class="bg-gray-200 py-2 px-4 grid content-center">
                            <p class="text-gray-900 text-sm">Сюжет: {{comment.plot}}/5</p>
                        </div>
                        <div class="bg-gray-200 py-2 px-4 grid content-center">
                            <p class="text-gray-900 text-sm">Игра актеров: {{comment.actors_game}}/5</p>
                        </div>
                        <div class="bg-gray-200 py-2 px-4 grid content-center">
                            <p class="text-gray-900 text-sm">Атмосфера: {{comment.atmosphere}}/5</p>
                        </div>
                        <div class="bg-gray-200 py-2 px-4 grid content-center">
        ...
        <section class="grid grid-flow-row gap-2">
            ...
            <form name="leaveComment" class="grid gap-2">
                        ...
                        <label>Сюжет:</label><br>
                            <ul class="grid grid-cols-[repeat(6,_40px)] grid-flow-col w-[240px] rounded-md overflow-hidden">
                                ...
                                <li v-for="item in 5" @click="countScore(item, commentsForm.actors_game, commentsForm.atmosphere)"
                                    ...
                                    :class="commentsForm.plot === item ? 'bg-[#333545] text-white' : 'bg-gray-300'"
                                >
                                    <span>{{item}}</span>
                                </li>
                            </ul>
                        ...
                        <div>
                                ...
                                <ul class="grid grid-cols-[repeat(6,_40px)] grid-flow-col w-[240px] rounded-md overflow-hidden">
                                    ...
                                    <li v-for="item in 5" @click="countScore(commentsForm.plot, item, commentsForm.atmosphere)"
                                        class="grid items-center justify-items-center cursor-pointer py-1"
                                        :class="commentsForm.actors_game === item ? 'bg-[#333545] text-white' : 'bg-gray-300'"
                                    >
                                        <span>{{item}}</span>
                                    </li>
                                </ul>
                        ...
                        <div>
                                ...
                                <ul class="grid grid-cols-[repeat(6,_40px)] grid-flow-col w-[240px] rounded-md overflow-hidden">
                                    ...
                                    <li v-for="item in 5" @click="countScore(commentsForm.plot, commentsForm.actors_game, item)"
                                        class="grid items-center justify-items-center cursor-pointer py-1"
                                        :class="commentsForm.atmosphere === item ? 'bg-[#333545] text-white' : 'bg-gray-300'"
                                    >
                                        <span>{{item}}</span>
                                    </li>
                                </ul>
                    ...
                    <div v-if="commentsForm.rating" class="self-end">
    ...
    export default {
        ...
        methods: {
            countScore(plot, actors, atmosphere ){
                this.commentsForm.plot = plot
                this.commentsForm.actors_game = actors
                this.commentsForm.atmosphere = atmosphere
