            ...
            <ul class="navbar-nav ml-auto">
                        ...
                        <form class="form-inline">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    <Link :href="this.route('search.index', {key: searchKey})" class="btn btn-navbar">
                                        <i class="fas fa-search"></i>
                                    </Link>
                ...
                <li v-if="playlist" class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <Link v-for="item in playlist" :href="this.route('single.index', {movie: item.id})" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
...
<!--                                        <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>-->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <Link :href="this.route('front.index')" class="brand-link">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li v-for="category in $page.props.categories" class="nav-item">
                            <Link  class="nav-link" :href="this.route('catalog.index', {category: category.id, order: 'year', page: '1', genre: '', type: ''})">
