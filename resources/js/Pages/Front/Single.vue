            ...
            <div class="col-xl-9 col-lg-9">
                ...
                <div class="bg-white p-3 widget shadow rounded mb-4">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a @click.prevent="getReviews()" class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Рецензии<span class="badge badge-danger badge-counter">{{reviews.total}}</span></a>
                        </li>
                    </ul>
                ...
                <div class="row d-flex align-content-center-start justify-content-start p-3 border-bottom">
                    ...
                    <div v-for="relatedMovie in relatedMovies" class="col-xl-3 col-md-4 col-sm-4 col-9 m-4 col-6">
                        <div  class="card e-card shadow border-0">
                            <Link :href="route('single.index', {movie: relatedMovie.id})" class=""><div class="m-card-cover">
