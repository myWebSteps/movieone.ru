            ...
            ">
                ...
                ">
                    ...
                    ">
                            ...
                            <li v-if="movie.facts_count > 0"
                                :class="accordion === 'facts' ? 'border-b-2 border-b-pink-900' : ''"
                                @click.prevent="accordion = 'facts'"
                        ...
                        >
                            ...
                            <div v-if="Object.entries(movie.bloopers).length > 0"
                                 class="grid grid-flow-row gap-4"
                            >
                            ...
                            <div v-if="Object.entries(movie.spoilers).length > 0"
                                 class="grid grid-flow-row gap-4"
                            >
                                <label class="grid grid-flow-col justify-between px-2 py-4 bg-gray-100 rounded-md
                                    cursor-pointer text-gray-500
                                    ">
                                    <span class="px-2">Спойлеры</span>
                                    <button class="px-2" type="button" @click="spoilersShow = !spoilersShow">
                                        <span class="grid grid-flow-col" v-if="!spoilersShow">
                                            <span>Показать</span>
                                            <span><i class="icon-keyboard_arrow_down"></i>
                                            </span>
                                        </span>
                                        <span class="grid grid-flow-col" v-if="spoilersShow">
                                            <span>Скрыть</span>
